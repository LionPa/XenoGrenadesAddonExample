...
public class Items {
    public static final Grenade gravityGrenade = new Grenade(Settings.GRAVITY_GRENADE_POWER, new GravityGrenadeBehavior(), Settings.GRAVITY_GRENADE_MODEL , Settings.GRAVITY_GRENADE_NAME, "gravity_grenade", Material.GRAY_CANDLE,Settings.GRAVITY_GRENADE_THROW_POWER,Settings.GRAVITY_GRENADE_DO_DISPENSER);
